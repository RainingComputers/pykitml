...
class LogisticRegression(_minimize_model.MinimizeModel):
    '''
    ...
    def __init__(self, input_size, output_size, reg_param=0):
        ...
        # Initilize functions
        self._softmax = _functions.softmax
        self._softmax_prime = _functions.softmax_prime
        self._cost_func = _functions.cross_entropy
        self._cost_func_prime = _functions.cross_entropy_prime
    ...
    def feedforward(self, input_data):
        ...
        self._activations = _functions.softmax(self._weighted_sum)
    ...
    def _backpropagate(self, target):
        ...
        B = 1
        # Gradients
        da_dz = self._softmax_prime(self._weighted_sum, self._activations)
